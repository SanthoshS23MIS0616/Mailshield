  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'base':['1.75rem',  { lineHeight: '2.625rem' }],
        'lg':  ['1.969rem', { lineHeight: '3rem' }],
        'xl':  ['2.188rem', { lineHeight: '3.25rem' }],
        '2xl': ['2.625rem', { lineHeight: '3.75rem' }],
        '3xl': ['3.281rem', { lineHeight: '4.375rem' }],
        '4xl': ['3.938rem', { lineHeight: '1.1' }],
